...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', help='input image dir', default='Input/Filtered')
    parser.add_argument('--input_name', help='training image name', default="Lenna.png")#required=True)
    parser.add_argument('--sr_factor', help='super resolution factor', type=float, default=3)
    ...
    #    print("output already exist")
        ...
        dir2save = functions.generate_dir2save(opt)
        imageio.imsave('%s/%s_HR.png' % (dir2save,opt.input_name[:-4]), functions.convert_image_np(out.detach()))
